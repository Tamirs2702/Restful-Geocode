...
def init_flask_restful_routes(app):
    ...
    from micro.api.getAddresses import HelloAPI, getResult
    ...
    api.add_resource(HelloAPI, '/api/v1/api/getResult')
    ...
    api.add_resource(getResult, '/api/v1/calc/<int:num1>/multiplied-by/<int:num2>')
